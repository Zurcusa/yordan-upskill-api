...
export class InitialSchema1750677260462 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "erc721" ("id" SERIAL NOT NULL, "tokenId" character varying(64) NOT NULL, "owner" character varying(42) NOT NULL, "mintedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b86a0f3ec92fa0f3f47ebf746ea" UNIQUE ("tokenId"), CONSTRAINT "PK_2b9fc1a11c2c01050de89befe31" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."auctions_status_enum" AS ENUM('active', 'ended', 'cancelled', 'created', 'extended')`);
